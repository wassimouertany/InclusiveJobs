    ...
    if (isCreatingJob) {
      return (
        <div className="bg-white p-8 rounded-2xl border border-border shadow-sm animate-in fade-in zoom-in-95 duration-200">
          <button type="button" onClick={() => setIsCreatingJob(false)} className="text-primary font-bold flex items-center gap-2 mb-6 hover:underline">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white text-gray-900 min-h-[100px] focus:border-primary outline-none" />
            </div>
            ...
            <div className="space-y-2">
              <label className="block text-sm font-bold text-gray-700">Possible Accommodations / Constraints</label>
              <textarea className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white text-gray-900 min-h-[100px] focus:border-primary outline-none" placeholder="Describe any physical constraints of the job or accommodations you can provide (e.g., Screen reader software available, Wheelchair accessible office)." />
            </div>
